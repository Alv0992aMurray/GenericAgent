...
> **Personal Fork Note:** I'm using this project primarily with the Gemini API. My setup notes and any personal tweaks are tracked in this fork for my own reference.
